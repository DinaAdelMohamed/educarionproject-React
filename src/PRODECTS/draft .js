    ...
    //     "id": 9789024561858,
    //     "title": "Inferno",
    //     "author": "Dan Brown lergnrojbhwproyjnmntjojypuojepojpojnmmmmmmmmmmmmtoyujp57o7777",
    ...
    //     "id": 9789400501157,
    //     "title": "De aanslag",
    //     "author": "David Baldaccihrgiothoihyihjrijhonpyojnopyo5yjh5",
    ...
    //         <img class="card-img-top p-2 "style={{height: '250px',borderRadius:'20px'}} src={item.image} alt="Card image cap"/>
    //         <div class="card-body">
    //         <h2 class="card-text">{item.title}</h2>
    //         <p class="card-text" >{item.author}</p>
    //         <h2 class="card-text mt-2" style={{color: 'red'}}> {item.price.value} $
    //         </h2>
    //         <br/>
    //         <Button size="lg" onClick={() => addItem(item)} variant="outline-secondary">Add to cart +</Button>
    //         </div>
    ...
    //     updateItemQuantity,
    //     removeItem,
    //     emptyCart,totalItems,cartTotal
    // } = useCart();
    ...
    // return (
    //     <div>
    //     <h1 className="text-center ">Cart Prodect  {totalUniqueItems}</h1>
        
    //     <Container>
    //     <Row>
    //         {items.map((item) => (
    //             <Cart class="card mb-3" style={{maxWidth:'450px'}}>
    //                   <div class="row g-0">
    //                   <Col class="col-md-4">
    //                   <img src={item.image}class="img-fluid rounded-start" style={{height:'200px'}} alt="..."/>
    //                   </Col>
    //                   <Col class="col-md-8">
    //   <div class="card-body">
    //     <h5 class="card-title">{item.title}</h5>
    //     <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
    //     <p class="card-text"><small class="text-muted">{item.price.value}</small></p>
    ...
    //                 &times;</button>      </div>
    //   <div>
    //   <h3 className="text-center">Total items is equal to {totalItems}
    //      And cart total price is equal{cartTotal }</h3>
    //     <button className="btn btn-danger d-flex justify-content-center  m-auto  "
    //      onClick={()=>emptyCart()}>Delet Allproudect</button>
    //     </div>
    // </Col>
