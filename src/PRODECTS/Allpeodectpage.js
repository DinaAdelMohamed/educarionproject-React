/* eslint-disable jsx-a11y/alt-text */
    ...
    import Header from "../HOME/Header";
        ...
        return (
            ...
            <Row className='row'>
                {products.map((item) => (
                    ...
                    <img class="card-img-top p-2 "style={{height: '250px',borderRadius:'20px'}} 
        ...
        // if (isEmpty) return <h2 className="text-center color red">Your cart is empty</h2>;
...
<h1 className="ml-2 text-center box"> OUR PRODECTS </h1>
</div>
            <Page /> 
            {/* <Cart /> */}
            </CartProvider>
